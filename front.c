...
/************************************************/
/* look up - a function to lookup operators and parenthesis
...
/* expr
    Parses strings in the language generated by the rul:
    <expr> -> <term> {(+ | -) <term>}
    */
void expr() {
  printf("Enter <expr>\n");
...
/* term
    Parse strings in the language generated by the rule:
    <term> -> <factor> {(* | /) <factor> }
    */
void term() {
  printf("Enter <term>\n");
